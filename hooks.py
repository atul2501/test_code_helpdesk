...
scheduler_events = {
    ...
    "hourly": [
        ...
        "helpdesk.api.manday.update_contract_status"
    ],
...
doc_events = {
    ...
    "Assignment Rule": {
        "on_trash":
            "helpdesk.extends.assignment_rule.on_assignment_rule_trash",

        "validate":
            "helpdesk.extends.assignment_rule.on_assignment_rule_validate",
    },

    "HD Ticket": {

        "before_save":
            "helpdesk.api.manday_hooks.hd_ticket_before_save",

        "on_update":
            "helpdesk.api.manday_hooks.hd_ticket_on_update"
    },

    "Manday Transaction": {

        "on_submit":"helpdesk.api.manday_hooks.manday_transaction_after_submit",
        "before_submit": "helpdesk.api.manday_hooks.manday_transaction_before_submit",
    },
